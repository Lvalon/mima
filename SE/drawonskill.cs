...
{
    public sealed class drawonskilldef : StatusEffectTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(drawonskill);
        }
        ...
        {
            return ResourceLoader.LoadSprite("sedrawonskill.png", embeddedSource);
        }
        ...
        [EntityLogic(typeof(drawonskilldef))]
        public sealed class drawonskill : mimaextensions.mimaexpartner
        {
