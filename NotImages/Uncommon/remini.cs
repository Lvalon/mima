...
namespace lvalonmima.NotImages.Uncommon
{
    public sealed class cardreminidef : CardTemplate
    {
        ...
        public sealed class cardremini : mimaextensions.mimacard
        {
            ...
            {
                List<Card> list = base.Battle.RollCards(new CardWeightTable(RarityWeightTable.AllOnes, OwnerWeightTable.OnlyPlayer, CardTypeWeightTable.OnlySkill), base.Value2, null).ToList<Card>();
                if (list.Count > 0)
                {
