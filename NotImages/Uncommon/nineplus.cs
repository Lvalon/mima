...
{
    public sealed class cardnineplusdef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(cardnineplus);
        }
        ...
        public override CardConfig MakeConfig()
        {
            CardConfig cardConfig = new CardConfig(
               ...
               IsXCost: false,
               Cost: new ManaGroup() { Any = 1, Hybrid = 2, HybridColor = 5 },
               UpgradedCost: new ManaGroup() { Any = 1, Hybrid = 1, HybridColor = 5 },
               MoneyCost: null,
               Damage: null,
               UpgradedDamage: null,
               Block: null,
        ...
        public sealed class cardnineplus : mimaextensions.mimacard
        {
