...
using static lvalonmima.SE.drawonskilldef;
    ...
    public sealed class cardmicrocosmosdef : CardTemplate
    {
        ...
        public override CardConfig MakeConfig()
        {
            var cardConfig = new CardConfig(
               ...
               Colors: new List<ManaColor>() { ManaColor.White, ManaColor.Blue, ManaColor.Green, ManaColor.Black, ManaColor.Colorless },
               IsXCost: false,
               Cost: new ManaGroup() { White = 1, Blue = 1, Green = 1, Black = 1, Colorless = 1 },
               ...
               RelativeEffects: new List<string>() { "ExtraTurn", "drawonskill" },
               UpgradedRelativeEffects: new List<string>() { "ExtraTurn", "drawonskill" },
        ...
        public sealed class cardmicrocosmos : mimaextensions.mimacard
        {
            protected override IEnumerable<BattleAction> Actions(UnitSelector selector, ManaGroup consumingMana, Interaction precondition)
            {
                ...
                yield return base.BuffAction<drawonskill>(1, 0, 0, 0, 0.2f);
