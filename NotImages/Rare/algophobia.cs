...
{
    public sealed class cardalgophobiadef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(cardalgophobia);
        }
        ...
        public override CardConfig MakeConfig()
        {
            var cardConfig = new CardConfig(
               ...
               Colors: new List<ManaColor>() { ManaColor.Blue, ManaColor.Green, ManaColor.Black },
               IsXCost: false,
               Cost: new ManaGroup() { Any = 1, Blue = 1, Green = 1, Black = 1 },
               UpgradedCost: null,
               MoneyCost: null,
               Damage: null,
               UpgradedDamage: null,
        ...
        public sealed class cardalgophobia : mimaextensions.mimacard
        {
