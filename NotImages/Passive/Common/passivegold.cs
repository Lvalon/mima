...
{
    public sealed class passivegolddef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(passivegold);
        }
        ...
        [EntityLogic(typeof(passivegolddef))]
        public sealed class passivegold : mimaextensions.mimacard.passivecard
        {
        }
    }
}
