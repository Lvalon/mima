...
{
    public sealed class cardpassivembdef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(cardpassivemb);
        }
        ...
        [EntityLogic(typeof(cardpassivembdef))]
        public sealed class cardpassivemb : mimaextensions.mimacard
        {
            public cardpassivemb() : base()
            {
                ispassive = true;
            }
        }
