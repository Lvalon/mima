...
{
    public sealed class passivembdef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(passivemb);
        }
        ...
        [EntityLogic(typeof(passivembdef))]
        public sealed class passivemb : mimaextensions.mimacard.passivecard
        {
        }
    }
}
