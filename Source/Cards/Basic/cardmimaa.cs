...
{
	public sealed class cardmimaaDef : lvalonmimaCardTemplate
	{
		public override CardConfig MakeConfig()
		{
			...
			config.GunName = GunNameID.GetGunFromId(25120);
			config.GunNameBurst = GunNameID.GetGunFromId(25121);

			//The card is treated as a basic card. 
			config.Keywords = Keyword.Basic | Keyword.FollowCard;
			config.UpgradedKeywords = Keyword.Basic | Keyword.FollowCard;

			config.Illustrator = "bloomkoffer";
	...
	[EntityLogic(typeof(cardmimaaDef))]
	public sealed class cardmimaa : lvalonmimaCard
	{
