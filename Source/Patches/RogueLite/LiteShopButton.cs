...
namespace lvalonmima.Source.Patches
{
	...
	public static class LocalisationKeys
	{
		...
		public static readonly Dictionary<(Locale, string), string> LocTable = new Dictionary<(Locale, string), string>
		{
			...
			[(Locale.En, $"{ShopPrefix}{BattlePrefix}block.Desc")] = "At the start of combat and the Challenger's first turn, gain {0} |Block|.",
			...
			[(Locale.En, $"{ShopPrefix}{BattlePrefix}graze.Desc")] = "At the start of combat and the Challenger's first turn, gain {0} |Graze|.",
			...
			[(Locale.En, $"{ShopPrefix}{DifficultyPrefix}reverse.Desc")] = "|Challenge Mode| will not skip the first Player Phase anymore, but <sprite=\"Point\" name=\"Point\"> cannot be saved if the |Challenger| loses, and only |c:50|% of the <sprite=\"Point\" name=\"Point\"> will be saved.",
			[(Locale.En, $"{ShopPrefix}{DifficultyPrefix}ascension")] = "Ascended",
			[(Locale.En, $"{ShopPrefix}{DifficultyPrefix}ascension.Desc")] = "Enemies are ascended, gaining unique buffs that serve as all-round challenges. Save |c:100|% more <sprite=\"Point\" name=\"Point\">.",
			...
			[(Locale.En, $"{ShopPrefix}QuestHistory.Active")] = "Completed Quests",
			[(Locale.En, $"{ShopPrefix}QuestHistory.Title")] = "Completed Quests",
			...
			[(Locale.ZhHant, $"{ShopPrefix}{InitPrefix}hp")] = "紅色格擋條",
			...
			[(Locale.ZhHant, $"{ShopPrefix}{BattlePrefix}block.Desc")] = "戰鬥開始和挑戰者的第一回合開始時，獲得 {0} 點|格擋|。",
			[(Locale.ZhHant, $"{ShopPrefix}{BattlePrefix}block.Next")] = "<b>|c:下一級|</b>：{1} 點|格擋|",
			[(Locale.ZhHant, $"{ShopPrefix}{BattlePrefix}graze")] = "敏捷身手",
			[(Locale.ZhHant, $"{ShopPrefix}{BattlePrefix}graze.Desc")] = "戰鬥開始和挑戰者的第一回合開始時，獲得 {0} 層閃避。",
			...
			[(Locale.ZhHant, $"{ShopPrefix}{DifficultyPrefix}reverse.Desc")] = "|挑戰者模式|不會再跳過玩家的首次行動，不過遊戲勝利時只會儲存 |c:50|% 的<sprite=\"Point\" name=\"Point\">，且遊戲失敗時不會儲存<sprite=\"Point\" name=\"Point\">。",
			[(Locale.ZhHant, $"{ShopPrefix}{DifficultyPrefix}ascension")] = "昇華",
			[(Locale.ZhHant, $"{ShopPrefix}{DifficultyPrefix}ascension.Desc")] = "敵人將被昇華，他們將獲得獨特的狀態，提供一個全方位的挑戰。多儲存 |c:100|% 的<sprite=\"Point\" name=\"Point\">。",
			...
			[(Locale.ZhHant, $"{ShopPrefix}QuestHistory.Active")] = "已完成任務",
			[(Locale.ZhHant, $"{ShopPrefix}QuestHistory.Title")] = "已完成任務",
			...
			[(Locale.ZhHans, $"{ShopPrefix}{InitPrefix}hp")] = "红色格挡条",
			...
			[(Locale.ZhHans, $"{ShopPrefix}{BattlePrefix}block.Desc")] = "战斗开始和挑战者的第一回合开始时，获得 {0} 点|格挡|。",
			[(Locale.ZhHans, $"{ShopPrefix}{BattlePrefix}block.Next")] = "<b>|c:下一级|</b>：{1} 点|格挡|",
			[(Locale.ZhHans, $"{ShopPrefix}{BattlePrefix}graze")] = "敏捷身手",
			[(Locale.ZhHans, $"{ShopPrefix}{BattlePrefix}graze.Desc")] = "战斗开始和挑战者的第一回合开始时，获得 {0} 层闪避。",
			...
			[(Locale.ZhHans, $"{ShopPrefix}{DifficultyPrefix}reverse.Desc")] = "|挑战者模式|不会再跳过玩家的首次行动，不过游戏胜利时只会储存 |c:50|% 的<sprite=\"Point\" name=\"Point\">，且游戏失败时不会储存<sprite=\"Point\" name=\"Point\">。",
			[(Locale.ZhHans, $"{ShopPrefix}{DifficultyPrefix}ascension")] = "升华",
			[(Locale.ZhHans, $"{ShopPrefix}{DifficultyPrefix}ascension.Desc")] = "敌人将被升华，他们将获得独特的状态，提供一个全方位的挑战。多储存 |c:100|% 的<sprite=\"Point\" name=\"Point\">。",
			...
			[(Locale.ZhHans, $"{ShopPrefix}QuestHistory.Active")] = "已完成任务",
			[(Locale.ZhHans, $"{ShopPrefix}QuestHistory.Title")] = "已完成任务",
