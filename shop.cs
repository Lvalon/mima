    ...
    public class shopplugin
    {
        ...
        public static IEnumerator shopCoroutineBlitz()
        {
            ...
            if (mimablitzlist.Count > 0)
            {
                ...
                foreach (Card card in mimabmlist)
                {
                    System.Random random = new System.Random();
                    int posorneg = random.Next(0, 3);
                    int cardcost = 0;
